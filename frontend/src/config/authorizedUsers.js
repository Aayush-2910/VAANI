...
export const getRoleForEmail = (email) => {
  ...
  if (AUTHORIZED_USERS.admin.includes(lowerEmail)) {
    ...
    // TEMPORARY FIX: Make ANY email volunteer for testing
    // Remove this after testing
    console.log('DEBUG: Email not in volunteer list, treating as volunteer for testing:', lowerEmail);
    return 'volunteer'; // Changed from 'user' to 'volunteer'
  }
};
